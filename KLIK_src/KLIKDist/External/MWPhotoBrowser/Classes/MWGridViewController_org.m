...
-(void)BatchLoadThumbnail:(PSTCollectionView *)collectionView;
@end
...
{
    return 2;
    //return [_browser numberOfSection];
}
- (NSInteger)collectionView:(UICollectionView *)view numberOfItemsInSection:(NSInteger)section {
    return [_browser numberOfPhotos];
    //return [_browser numberOfPhotosInSection:section];
}
...
- (PSTCollectionViewCell *)collectionView:(PSTCollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    } else
    {
        ...
        {
            [self BatchLoadThumbnail:collectionView];
